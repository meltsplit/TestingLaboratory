...
enum ServiceError: Int, Error, CustomStringConvertible {
    ...
    var errorDescription: String {
        switch self {
        case .invalidURL: return "INVALID_URL_ERROR"
        ...
        case .decodedFail: return "RESPONSE_DECODING_ERROR"
        case .encodedFail: return "REQUEST_BODY_ENCODING_ERROR"
        ...
        case .responseFail: return "conflicted"
        }
    }
